...
import { updateNote,deleteNote } from "../../../app/slices/notesSlice"
import { selectNotesError } from "./notesSelector"
...
const EditNoteForm = ({note,users}) => {
    ...
    const onSaveNoteClicked = async (e) => {
        e.preventDefault();
        if (canSave) {
            await dispatch(updateNote({ id: note.id, user: userId, title, text, completed }))
            navigate("/dash/notes")
        }
    }
